#> pk_racks:blocks/rack/actions/break/loot_item/left
#
...
data modify storage pk:common package.dynamic_item.args.entity_data.Item set from storage pk:common temp.rack.items[0]
