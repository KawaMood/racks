#> pk_racks:blocks/rack/entities/items/create/ground/_run
#
...
# Set type
data modify storage pk:common temp.item_args.type set value "ground"
...
#   right
data modify storage pk:common temp.item_args.part set value "right"
execute summon item_display run function pk_racks:blocks/rack/entities/items/create/initialize_single with storage pk:common temp.item_args