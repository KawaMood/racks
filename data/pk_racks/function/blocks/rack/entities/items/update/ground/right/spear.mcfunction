...
#   1
execute if score $pose pk.temp matches 1 run data modify entity @s transformation merge value {left_rotation:[0f,0.383f,0f,0.924f],translation:[-.085f,.68f,.09f]}
#   2
execute if score $pose pk.temp matches 2 run data modify entity @s transformation merge value {left_rotation:[0f,-0.383f,0f,0.924f],translation:[-.225f,.68f,.09f]}
#   3
