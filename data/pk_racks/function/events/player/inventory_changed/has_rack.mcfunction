...
execute if items entity @s container.* player_head[custom_data~{pk_data:{id:"rack",from:"racks"}},!custom_data~{pk_data:{version:30001s}}] run function pk_racks:items/rack/update/run {version:30001s}
