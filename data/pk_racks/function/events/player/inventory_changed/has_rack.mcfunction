...
execute if items entity @s container.* #pk_racks:placer[custom_data~{pk_data:{id:"rack",from:"racks"}},!custom_data~{pk_data:{version:30300s}}] run function pk_racks:items/rack/update/run {version:30300s}
